...
Simple model to predict housing prices using from latitude, longitude, lot area, number of bedrooms, number of bathrooms, along with derived features like floorplan density and distance to the nearest metropolitan area. Built using pytorch, data cleaned and prepped using pandas, numpy.
