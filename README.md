...
switch datasets, as I realized too late that my original data includes rent estimates, but not house sale prices, 
which is what I was going for. I am not yet sure if I want to persue  What this process lacked in cleanliness, 
it made up for in learning experiences. It highlighted the importance of data visualization and interpretation 
before starting a project, and secured a lot of fundamentals of how models should be set up and tuned.
